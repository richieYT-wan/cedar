...
def args_parser():
    ...
    parser.add_argument('-outdir', type=str, default='../output/221122_new_core_mutscores_trainMerged_eval_switchPRIME/')
...
def main():
    ...
    train_dataset = pd.read_csv(f'{args["datadir"]}221112_cedar_prime_merged_fold.csv')
