...
def args_parser():
    ...
    parser.add_argument('-outdir', type=str, default='../output/221217_non_top_HLA/')
...
def main():
    ...
    cedar_dataset = pd.read_csv(f'{args["datadir"]}221217_prime_non_top_5fold.csv')
    prime_dataset = pd.read_csv(f'{args["datadir"]}221217_cedar_non_top_5fold.csv')
