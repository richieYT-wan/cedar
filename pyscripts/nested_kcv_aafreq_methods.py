...
#
#
# def train_wrapper(train_dataset, model, ics_dict, ics_name, mode,
...
#         pass
#     else:
#         models, train_results, test_results = nested_kcv_train_sklearn(train_dataset, model, ics_dict, mode, encoding_kwargs)
...
#     dataset_cedar_hp_rank_high = 'xd'
#     dataset_cedar_virus = 'xd'
...
#     train_datasets = [dataset_cedar, dataset_cedar_hp_rank_low, dataset_cedar_hp_rank_high, dataset_cedar_virus]
