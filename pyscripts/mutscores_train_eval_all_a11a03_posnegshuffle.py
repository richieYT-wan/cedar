...
def args_parser():
    ...
    parser.add_argument('-outdir', type=str, default='../output/230109_ALL_a11posnegshuffle/')
...
def main():
    ...
    cedar_noa11a03neg = cedar_dataset.drop(index=cedar_dataset.query('(HLA=="HLA-A1101" and agg_label==0) or (HLA=="HLA-A0301" and agg_label==0)').index)
    cedar_noa11a03pos = cedar_dataset.drop(index=cedar_dataset.query('(HLA=="HLA-A1101" and agg_label==1) or (HLA=="HLA-A0301" and agg_label==1)').index)
    cedar_noa11a03 = cedar_dataset.query('HLA!="HLA-A1101" and HLA != "HLA-A0301"')

    for train_dataset, trainname in zip([cedar_dataset, cedar_noa11a03neg, cedar_noa11a03pos, cedar_noa11a03],
                                        ['all', 'all_noA11-A03_neg', 'all_noA11-A03_pos', 'all_noA11-noA03']):
        if trainname != 'all':
        ...
        for invert in [True, False]:
            for ic_name, ics_dict in tqdm(
                ...
                for evalset, evalname in zip([cedar_dataset, cedar_noa11a03neg, cedar_noa11a03pos, cedar_noa11a03, prime_dataset, ibel_dataset],
                                        ['all', 'all_noA11-A03_neg', 'all_noA11-A03_pos', 'all_noA11-noA03', 'prime', 'ibel']):
