# ../../morni/bin/hobohm1_pepkernel -kmin 4 -kmax 8 -t 0.85 -st 1 cedar_peps.pep
# Thu Aug  4 11:51:38 2022
# User: yatwan
...
# -t       0.850000             Threshold for similarity
...
#	[-t float]           0.850000             Threshold for similarity
...
# Not unique. 250 ATSPASASK is similar to ASNASSAAK 0.868770
...
# Not unique. 652 FMLYLLTLM is similar to FILLLFLTIFI 0.855841
...
# Not unique. 788 GASSATAVL is similar to ASNASSAAK 0.857530
...
# Not unique. 991 HPQASSAVGF is similar to EEKAASSLVSY 0.854788
...
# Not unique. 1288 KIPVAITSPK is similar to IPVAIKTSP 0.861753
...
# Not unique. 1384 KLVVVAVGV is similar to KLFAIVVGRGI 0.852166
...
# Not unique. 1571 LFLSASSNSF is similar to FLMASISSF 0.851431
...
# Not unique. 1669 LLMLLIGFL is similar to FILLLFLTIFI 0.855182
...
# Not unique. 1707 LMAVAILKEV is similar to FMDMAILVES 0.852472
# Not unique. 1708 LMAVRSKYSEV is similar to FMEAVSSKYSM 0.872428
...
# Not unique. 1839 LVVVGASGVGK is similar to AVMGAGSSGTA 0.851829
...
# Not unique. 1864 MASFLVFYVI is similar to HSMASFLVFY 0.869891
...
# Not unique. 1884 MILTGILLIEI is similar to FGLLGNILLVI 0.857688
...
# Not unique. 1911 MLMLAVIVA is similar to FLLLVAAMI 0.856650
...
# Not unique. 2428 RTNTGILETLK is similar to NTVILETLK 0.850939
...
# Not unique. 2556 SLDVLMAVAIL is similar to FLLLVAAMI 0.850545
...
# Not unique. 2567 SLGAQTAAA is similar to GTKAATAAAR 0.853090
...
# Not unique. 2631 SLSSLTATTQA is similar to FSMAKTSTSL 0.851569
# Not unique. 2632 SLSSSGAPSL is similar to LSSSGAPSLK 0.944153
# Not unique. 2633 SLSSSGAPSL is similar to LSSSGAPSLK 0.944153
# Not unique. 2634 SLSSSGAPSLK is similar to HSSSGSSLTLF 0.856965
# Not unique. 2635 SLSTIKDIISL is similar to LQTIKDIASPI 0.874314
...
# Not unique. 2701 SPNQSSTSNEM is similar to MPGRSSSNSA 0.853109
...
# Not unique. 2733 SQYPSSFSTAK is similar to NYQSFSSTSAL 0.859801
...
# Not unique. 2742 SSASTESPAF is similar to SASTESPAF 0.974834
...
# Not unique. 2760 SSLSSSGAPSL is similar to ASNASSAAK 0.854328
# Unique. 2761 SSMESRLLK
# Not unique. 2762 SSNLFSSSSF is similar to NYQSFSSTSAL 0.854569
...
# Not unique. 3046 VKITDFGRAK is similar to ITDFGRAKL 0.857324
...
# Not unique. 3066 VLICLRLLMRY is similar to SVVLLLRLAK 0.858692
# Not unique. 3067 VLIDAVVDGQV is similar to KILDAVVAQK 0.866744
...
# Not unique. 3078 VLLTVTESVLK is similar to LTVETLTKV 0.850998
# Unique. 3079 VLLYAEIYA
# Not unique. 3080 VLMAVAILK is similar to MLSILALVRV 0.851313
# Not unique. 3081 VLMAVAILKEV is similar to FMDMAILVES 0.855655
# Unique. 3082 VLMGAVALGA
# Not unique. 3083 VLMGAVALGAL is similar to MEAVALVGAW 0.853862
...
# Not unique. 3094 VLSSLVLVPL is similar to AISLLSLPL 0.862542
...
# Not unique. 3101 VLVTFEDVAV is similar to MLVLTFRDVAV 0.873723
...
# Not unique. 3119 VMLEEILKTL is similar to MLLENVLKPL 0.862345
...
# Not unique. 3130 VPGASSATAVL is similar to ASNASSAAK 0.868886
...
# Not unique. 3188 VYALIAGATL is similar to RIALILAGSK 0.855444
# Not unique. 3189 VYALIAGATL is similar to RIALILAGSK 0.855444
...
# Not unique. 3218 WLLMLLIGFL is similar to FILLLFLTIFI 0.867610
...
# Not unique. 3257 WYTHNLIF is similar to FWYTHNLIFVF 0.855667
...
# Not unique. 3433 YTHNLIFVFYM is similar to FWYTHNLIFVF 0.858309
