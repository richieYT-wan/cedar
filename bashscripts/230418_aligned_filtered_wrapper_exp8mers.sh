...
python3 ./aligned_icore_expr_mut_oh_filtered_aaprops_exp8mers.py -icsdir \${ICSDIR} -trainset \${TRAINSET} -ncores 39 -outdir \${OUTDIR} -condition \${CONDITION}
" > "230414_aligned_expr_mut_oh_filt_${1}_exp8mers.sh"

chmod +x "230414_aligned_expr_mut_oh_filt_${1}_exp8mers.sh"
qsub -W group_list=vaccine -A vaccine -m e -l nodes=1:ppn=40:thinnode,mem=100gb,walltime=${WALLTIME} "./230414_aligned_expr_mut_oh_filt_${1}_exp8mers.sh"
